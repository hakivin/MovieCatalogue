...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        sendNotification(context, title, message, code);
    ...
    public void setRepeatingAlarm(Context context, String time, String title, String message, int requestCode){
        ...
        if (alarmManager != null) {
            System.out.println("setRepeatingAlarm called, getTimeMillis = " + calendar.getTimeInMillis() + "current time = " + calendar.getTime());
